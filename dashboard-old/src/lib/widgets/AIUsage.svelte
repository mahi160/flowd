<script lang="ts">
  ...
  const byModel = [
    { id: "sonnet", label: "Claude Sonnet 4.5", value: 192, valueLabel: "$1.92", color: "var(--primary)" },
    { id: "haiku", label: "Claude Haiku 4.5", value: 74, valueLabel: "$0.74", color: "var(--accent)" },
    { id: "gpt5", label: "GPT-5", value: 46, valueLabel: "$0.46", color: "var(--warning)" },
    { id: "pi", label: "Pi", value: 30, valueLabel: "$0.30", color: "var(--danger)" },
  ];

  const byTool = [
    { id: "claude-code", label: "Claude Code", value: 218, valueLabel: "$2.18", color: "var(--primary)" },
    { id: "cursor", label: "Cursor", value: 78, valueLabel: "$0.78", color: "var(--accent)" },
    { id: "aider", label: "aider", value: 32, valueLabel: "$0.32", color: "var(--warning)" },
    { id: "copilot", label: "Copilot", value: 14, valueLabel: "$0.14", color: "var(--danger)" },
  ];
  ...
  <div>
    ...
    <div class="flex h-2 rounded-full overflow-hidden border border-border">
      {#each byModel as s (s.id)}
        <span class="block h-full" style:flex={s.value} style:background={s.color}
        ></span>
      {/each}
    </div>
