...
export function SvgIcon({ html, size = 16 }: { html: string; size?: number }) {
  return (
    <span
...
export function FlowMark({ size = 40 }: { size?: number }) {
