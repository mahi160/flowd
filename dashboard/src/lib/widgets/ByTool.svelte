<script lang="ts">
  ...
  const total = "4h 02m";
  const slices = [
    { id: "nvim", label: "nvim", value: "1h 26m", pct: 36, color: "var(--primary)" },
    { id: "node", label: "node", value: "1h 00m", pct: 25, color: "var(--accent)" },
    { id: "claude", label: "Claude Code", value: "42m", pct: 17, color: "var(--warning)" },
    { id: "tmux", label: "[tmux]", value: "19m", pct: 8, color: "var(--danger)" },
    { id: "lazygit", label: "lazygit", value: "14m", pct: 6, color: "color-mix(in oklch, var(--primary) 50%, var(--accent))" },
    { id: "zsh", label: "zsh", value: "11m", pct: 5, color: "color-mix(in oklch, var(--accent) 50%, var(--warning))" },
    { id: "other", label: "Other", value: "10m", pct: 4, color: "var(--foreground)" },
  ];
