<script lang="ts">
  ...
  const entries: Block[] = [
    ...
    },
    {
      ...
      focus: 50,
      switches: 1,
      note: "longest block · aggregate.ts",
    },
    ...
    },
    {
      ...
      focus: 38,
      switches: 0,
      note: "session refactor",
    },
    {
      start: "12:30",
      end: "13:30",
      idle: true,
      note: "distraction · lunch away",
    },
    {
      start: "13:30",
      end: "15:00",
      ...
      focus: 78,
      switches: 2,
      note: "dashboard split",
    },
    {
      start: "15:00",
      end: "16:00",
      idle: true,
      note: "meeting · standup + review",
    },
    {
      start: "16:00",
      end: "18:00",
