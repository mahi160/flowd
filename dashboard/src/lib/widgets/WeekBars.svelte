<script lang="ts">
  ...
  const days = [
    { date: "2026-04-27", label: "Mon 27", focus: 240, focusLabel: "4h 00m", isToday: false, isBest: false },
    { date: "2026-04-28", label: "Tue 28", focus: 312, focusLabel: "5h 12m", isToday: false, isBest: false },
    { date: "2026-04-29", label: "Wed 29", focus: 198, focusLabel: "3h 18m", isToday: false, isBest: false },
    { date: "2026-04-30", label: "Thu 30", focus: 384, focusLabel: "6h 24m", isToday: false, isBest: true },
    { date: "2026-05-01", label: "Fri 01", focus: 264, focusLabel: "4h 24m", isToday: false, isBest: false },
    { date: "2026-05-02", label: "Sat 02", focus: 60, focusLabel: "1h 00m", isToday: false, isBest: false },
    { date: "2026-05-03", label: "Sun 03", focus: 342, focusLabel: "5h 42m", isToday: true, isBest: false },
  ];
  ...
  <div class="grid grid-cols-7 gap-2 h-[200px] mt-2">
    {#each days as d (d.date)}
      <div class="flex flex-col">
        <div
          class="flex-1 bg-background rounded-xl relative overflow-hidden"
        >
          <span
