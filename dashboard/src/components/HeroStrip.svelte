...
<section class="grid grid-cols-[1.5fr_1fr_1fr_1fr] gap-4 max-lg:grid-cols-[1.4fr_1fr_1fr] max-md:grid-cols-2">
  <!-- Focus -->
  <div class="rounded-xl border border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-stone-900 shadow-sm dark:shadow-stone-950/30 p-5 flex flex-col gap-1.5 min-h-[140px]">
    ...
    <div class="text-xs text-stone-500 mt-1">
      <span class="font-mono tabular-nums font-medium text-stone-700 dark:text-stone-300">{f.blocks}</span> blocks
      <span class="text-stone-300 dark:text-stone-600 mx-1">·</span>
      <span class="font-mono tabular-nums font-medium text-stone-700 dark:text-stone-300">{f.switches}</span> switches
    </div>
  ...
  <!-- Code -->
  <div class="rounded-xl border border-stone-200 dark:border-stone-800 bg-stone-50 dark:bg-stone-900 shadow-sm dark:shadow-stone-950/30 p-5 flex flex-col gap-1.5 min-h-[140px] max-lg:hidden max-md:flex">
